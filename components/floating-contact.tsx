...
const phoneInfo = contactData.info[0].details[0];
const phone = phoneInfo.text;
const phoneLink = 'link' in phoneInfo ? phoneInfo.link : "";
const facebook = social.find((s) => s.platform === "facebook")!;
const line = social.find((s) => s.platform === "line")!;
